...
System.out.println("main started");
	...
	System.out.println("name of the user is " + media1.name);
	System.out.println("profile name of user is "+ media1.profileName);
	System.out.println("emial of the user is "+media1.email);
	...
	System.out.println("name of the user is " + media2.name);
	System.out.println("profile name of user is "+ media2.profileName);
	System.out.println("emial of the user is "+media2.email);
	...
	System.out.println("name of the user is " + media3.name);
	System.out.println("profile name of user is "+ media3.profileName);
	System.out.println("emial of the user is "+media3.email);
	...
	System.out.println("name of the user is " + media4.name);
	System.out.println("profile name of user is "+ media4.profileName);
	...
	System.out.println("emial of the user is "+media8.email);
